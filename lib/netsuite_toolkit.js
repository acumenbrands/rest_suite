...
NetsuiteToolkit.SublistProcessor = (function() {
  ...
  function SublistProcessor(record, sublist_data) {
    this.record       = record;
    this.sublist      = sublist_data['name'];
  ...
  SublistProcessor.prototype.createLineItem = function(creation_request) {
    ...
    if(!index) {
      index = NetsuiteToolkit.getLineItemCount(this.record, this.sublist);
    }

    if(this.sublist == 'addressbook') {
      NetsuiteToolkit.selectNewLineItem(this.record, this.sublist );

      for(field in data) {
        value = data[field];
        NetsuiteToolkit.setCurrentLineItemValue(this.record, this.sublist, field, value);
      }
      ...
      NetsuiteToolkit.commitLineItem(this.record, this.sublist);
    } else {
      NetsuiteToolkit.insertLineItem(this.record, this.sublist, index);
  ...
  SublistProcessor.prototype.exciseLineItem = function(excise_request) {
    ...
    NetsuiteToolkit.removeLineItem(this.record, this.sublist, index);
  }
  ...
  SublistProcessor.prototype.updateLineItemFields = function(index, line_item_data) {
    for(field in line_item_data) {
      ...
      NetsuiteToolkit.setLineItemValue(this.record, this.sublist, field, index, value);
    }
  }
  ...
  SublistProcessor.prototype.matchLineItemByField = function(match_field, data) {
    ...
    count       = NetsuiteToolkit.getLineItemCount(this.record, this.sublist);
  ...
  SublistProcessor.prototype.compareLineItemValue = function(index, match_field, match_value) {
    netsuite_value = NetsuiteToolkit.getLineItemValue(this.record, this.sublist,
                                                      index, match_field);
