...
var type_not_lower_case = "Transform record types must be all lower case.";
...
this.TransformRequest = (function() {
  ...
  TransformRequest.prototype.execute = function() {
    ...
    if(this.source_type !== this.source_type.toLowerCase() ||
       this.result_type !== this.result_type.toLowerCase()){ throw TransformRequest.TypeNotLowerCase; }
...
this.TransformRequest.TypeNotLowerCase = new Error(type_not_lower_case);
