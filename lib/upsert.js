...
this.UpsertRequest = (function() {
  ...
  UpsertRequest.prototype.processUpdateLiterals = function() {
    if(this.record.getRecordType() == 'customer') {
      /*
       * Having same companyname in the data hash will trigger duplicate key exception
       */
      if(this.literal_field_data['companyname'] == NetsuiteToolkit.getFieldValue(this.record, 'companyname') ) {
         delete this.literal_field_data['companyname'];
      }
    }    
