...
this.UpsertRequest = (function() {
  ...
  function UpsertRequest(record_data) {
    ...
    this.do_sourcing = record_data['do_sourcing'] || null;
    this.ignore_mandatory = record_data['ignore_mandatory'] || null;
  ...
  UpsertRequest.prototype.execute = function() {
    ...
    this.written_id = NetsuiteToolkit.submitRecord(this.record, this.do_sourcing, this.ignore_mandatory);
  }
